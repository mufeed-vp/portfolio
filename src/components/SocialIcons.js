const SocialIcons = () => {
  ...
  return (
    <div className="socialIcons" style={styles.socialIcons}>
      <a className="icon" style={styles.icon} href="https://github.com/mufeed-vp" target="_blank" rel="noreferrer">
        <i className="fa-brands fa-github" aria-hidden="true" title="Mufeed V P' GitHub Profile"></i>
      </a>
      <a className="icon" style={styles.icon} href="https://www.linkedin.com/in/mufeed-vp/" target="_blank" rel="noreferrer">
        <i className="fa-brands fa-linkedin" aria-hidden="true" title="Mufeed V P' LinkedIn Profile"></i>
      </a>
      <a className="icon" style={styles.icon} href="https://www.instagram.com/mf_mufi/" target="_blank" rel="noreferrer">
